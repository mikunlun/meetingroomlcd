package hackathon.display.lcd.i2c;
...
/**
 * http://www.raspext.com/forum/viewtopic.php?f=6&t=3
 */
@SuppressWarnings("unused")
public class LiquidCrystal_I2C extends GpioProviderBase implements GpioProvider {
	public static Logger log = LoggerFactory.getLogger(LiquidCrystal_I2C.class);
	...
	private static final int En = 0x04; // Enable
										// bit
	private static final int Rw = 0x02; // Read/Write
										// bit
	private static final int Rs = 0x01; // Register
										// select
										// bit
	 ...
	 * 
	 * @param busNumber
	 *            I2C bus number, this is normally the first one : I2CBus.BUS_0
	 * @param address
	 *            address of the PCF8574 is 0x27 by default
	 ...
	 * 
	 * @param b
	 *            Set it to true to display cursor
	 */
	 ...
	 * 
	 * @param b
	 *            Set it to true to have blinking cursor
	 */
	 ...
	 * 
	 * @param b
	 *            Set it to true to have backlight
	 */
	 ...
	 * 
	 * @param col
	 *            Specify the display column
	 * @param row
	 *            Specify the display row
	 */
	 ...
	 * 
	 * @param b
	 *            Set it to true to enable display
	 */
	 ...
	 * @param location
	 * @param charmap
	 *            Contain 8 chars for each line (5x8 dots)
	 */
	...
	private static void delayMicroseconds(int value) {
		try {
			Thread.sleep(0, value * 100);
		} catch (InterruptedException ex) {
			log.warn("delayMicroseconds", ex);
		}
	}

	private static void delayMilliseconds(int value) {
		try {
			Thread.sleep(value);
		} catch (InterruptedException ex) {
	...
	public static void main(String[] args) {
		...
		try {
			lcd = new LiquidCrystal_I2C(1, 0x27, 20, 4);
			lcd.backlight(true);
			...
			for (int i = 1; i <= 3; i++) {
				for (int j = 0; j < 20; j++) {
					lcd.print(String.valueOf(x++).charAt(0));
