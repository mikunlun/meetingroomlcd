...
public class MeetingRequest extends MeetingMessage implements ICalendarActionProvider {
  ...
  public MeetingRequestType getMeetingRequestType() throws ServiceLocalException {
    return (MeetingRequestType) this.getPropertyBag().getObjectFromPropertyDefinition(MeetingRequestSchema.MeetingRequestType);
  }
  ...
  public LegacyFreeBusyStatus getIntendedFreeBusyStatus() throws ServiceLocalException {
    return (LegacyFreeBusyStatus) this.getPropertyBag().getObjectFromPropertyDefinition(MeetingRequestSchema.IntendedFreeBusyStatus);
  ...
  public LegacyFreeBusyStatus legacyFreeBusyStatus() throws ServiceLocalException {
    return (LegacyFreeBusyStatus) this.getPropertyBag().getObjectFromPropertyDefinition(AppointmentSchema.LegacyFreeBusyStatus);
  }
  ...
  public AppointmentType getAppointmentType() throws ServiceLocalException {
    return (AppointmentType) this.getPropertyBag().getObjectFromPropertyDefinition(AppointmentSchema.AppointmentType);
  }
  ...
  public MeetingResponseType getMyResponseType() throws ServiceLocalException {
    return (MeetingResponseType) this.getPropertyBag().getObjectFromPropertyDefinition(AppointmentSchema.MyResponseType);
  }
  ...
  public ItemCollection<Appointment> getConflictingMeetings() throws ServiceLocalException {
    return (ItemCollection<Appointment>) this.getPropertyBag().getObjectFromPropertyDefinition(AppointmentSchema.ConflictingMeetings);
  }
  ...
  public ItemCollection<Appointment> getAdjacentMeetings() throws ServiceLocalException {
    return (ItemCollection<Appointment>) this.getPropertyBag().getObjectFromPropertyDefinition(AppointmentSchema.AdjacentMeetings);
  }
