...
public abstract class PropertyDefinition extends ServiceObjectPropertyDefinition {
   ...
   *
   * @param properties The list in which to add the associated properties.
   */
   ...
   */
  protected abstract void loadPropertyValueFromXml(EwsServiceXmlReader reader, PropertyBag propertyBag) throws ServiceXmlDeserializationException, XMLStreamException, InstantiationException, IllegalAccessException, ServiceObjectPropertyException, ServiceVersionException, Exception;
   ...
   * @throws Exception                  the exception
   */
  protected abstract void writePropertyValueToXml(EwsServiceXmlWriter writer, PropertyBag propertyBag, boolean isUpdateOperation) throws XMLStreamException, ServiceXmlSerializationException, ServiceLocalException, InstantiationException, IllegalAccessException, ServiceValidationException, Exception;
