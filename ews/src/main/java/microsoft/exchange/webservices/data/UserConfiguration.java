...
public class UserConfiguration {
   ...
   */
  private final static EnumSet<UserConfigurationProperties> PropertiesAvailableForNewObject = EnumSet.of(UserConfigurationProperties.BinaryData, UserConfigurationProperties.Dictionary, UserConfigurationProperties.XmlData);
  ...
  protected UserConfiguration(ExchangeService service, EnumSet<UserConfigurationProperties> requestedProperties) throws Exception {
    ...
    if (service.getRequestedServerVersion().ordinal() < this.ObjectVersion.ordinal()) {
      throw new ServiceVersionException(String.format(Strings.ObjectTypeIncompatibleWithRequestVersion, this.getClass().getName(), this.ObjectVersion));
    }
  ...
  public boolean getIsDirty() {
    return (!this.updatedProperties.contains(NoProperties)) || this.dictionary.getIsDirty();
  }
  ...
  public void update() throws Exception {
    ...
    if (this.isPropertyUpdated(UserConfigurationProperties.BinaryData) || this.isPropertyUpdated(UserConfigurationProperties.
            Dictionary) || this.isPropertyUpdated(UserConfigurationProperties.
            XmlData)) {
  ...
  protected void writeToXml(EwsServiceXmlWriter writer, XmlNamespace xmlNamespace, String xmlElementName) throws Exception {
    ...
    writeUserConfigurationNameToXml(writer, XmlNamespace.Types, this.name, this.parentFolderId);
  ...
  private void writeBinaryDataToXml(EwsServiceXmlWriter writer) throws XMLStreamException, ServiceXmlSerializationException {
    ...
    writeByteArrayToXml(writer, this.binaryData, XmlElementNames.BinaryData);
  }
  ...
  protected void loadFromXml(EwsServiceXmlReader reader) throws Exception {
    ...
    do {
      if (reader.getNodeType().getNodeType() == XMLNodeType.START_ELEMENT) {
        if (reader.getLocalName().equals(XmlElementNames.UserConfigurationName)) {
        ...
        } else if (reader.getLocalName().equals(XmlElementNames.Dictionary)) {
