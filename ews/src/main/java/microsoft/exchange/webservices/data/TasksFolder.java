...
public class TasksFolder extends Folder {
   ...
   * @throws Exception the exception
   */
  public static TasksFolder bind(ExchangeService service, FolderId id, PropertySet propertySet) throws Exception {
   ...
   * @throws Exception the exception
   */
  public static TasksFolder bind(ExchangeService service, FolderId id) throws Exception {
    return TasksFolder.bind(service, id, PropertySet.getFirstClassProperties());
  }
   ...
   * @throws Exception the exception
   */
  public static TasksFolder bind(ExchangeService service, WellKnownFolderName name, PropertySet propertySet) throws Exception {
   ...
   * @throws Exception the exception
   */
  public static TasksFolder bind(ExchangeService service, WellKnownFolderName name) throws Exception {
    return TasksFolder.bind(service, new FolderId(name), PropertySet.getFirstClassProperties());
  }
