...
final class DeleteItemRequest extends DeleteRequest<ServiceResponse> {
   ...
   * @throws Exception
   */
  DeleteItemRequest(ExchangeService service, ServiceErrorHandling errorHandlingMode) throws Exception {
  ...
  protected void writeAttributesToXml(EwsServiceXmlWriter writer) throws ServiceXmlSerializationException {
    ...
    if (this.affectedTaskOccurrences != null) {
      writer.writeAttributeValue(XmlAttributeNames.AffectedTaskOccurrences, this.getAffectedTaskOccurrences());
    }

    if (this.sendCancellationsMode != null) {
      writer.writeAttributeValue(XmlAttributeNames.SendMeetingCancellations, this.getSendCancellationsMode());
    }
  }
   ...
   */
  void setAffectedTaskOccurrences(AffectedTaskOccurrence affectedTaskOccurrences) {
