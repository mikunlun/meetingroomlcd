...
public class ContactGroup extends Item {
  ...
  public String getFileAs() throws Exception {
    return (String) this.getObjectFromPropertyDefinition(ContactSchema.FileAs);
  }
  ...
  public String getDisplayName() throws Exception {
    return (String) this.getObjectFromPropertyDefinition(ContactSchema.DisplayName);
  }
  ...
  public GroupMemberCollection getMembers() throws Exception {
    return (GroupMemberCollection) this.getObjectFromPropertyDefinition(ContactGroupSchema.Members);
  ...
  public static ContactGroup bind(ExchangeService service, ItemId id) throws Exception {
    return ContactGroup.bind(service, id, PropertySet.getFirstClassProperties());
  }
   ...
   */
  @Override
  protected void setSubject(String subject) throws ServiceObjectPropertyException {
