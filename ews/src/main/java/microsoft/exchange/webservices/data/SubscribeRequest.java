 ...
 */
abstract class SubscribeRequest<TSubscription extends SubscriptionBase> extends MultiResponseServiceRequest<SubscribeResponse<TSubscription>> {
  ...
  protected void writeElementsToXml(EwsServiceXmlWriter writer) throws Exception {
    ...
    this.getFolderIds().writeToXml(writer, XmlNamespace.Types, XmlElementNames.FolderIds);
    ...
    if (!(this.getWatermark() == null || this.getWatermark().isEmpty())) {
      writer.writeElementValue(XmlNamespace.Types, XmlElementNames.Watermark, this.getWatermark());
    }
