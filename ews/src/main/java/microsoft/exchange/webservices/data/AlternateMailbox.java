...
public final class AlternateMailbox {
   ...
   */
  protected static AlternateMailbox loadFromXml(EwsXmlReader reader) throws Exception {
    ...
    do {
      ...
      if (reader.getNodeType().getNodeType() == XMLNodeType.START_ELEMENT) {
        ...
        } else if (reader.getLocalName().equalsIgnoreCase(XmlElementNames.DisplayName)) {
          altMailbox.setDisplayName(reader.readElementValue(String.class));
        } else if (reader.getLocalName().equalsIgnoreCase(XmlElementNames.LegacyDN)) {
          altMailbox.setLegacyDN(reader.readElementValue(String.class));
        } else if (reader.getLocalName().equalsIgnoreCase(XmlElementNames.Server)) {
