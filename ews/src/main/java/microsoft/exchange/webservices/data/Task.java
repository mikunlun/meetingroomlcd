...
public class Task extends Item {
  ...
  public TaskDelegationState getDelegationState() throws ServiceLocalException {
    return (TaskDelegationState) this.getPropertyBag().getObjectFromPropertyDefinition(TaskSchema.DelegationState);
  }
  ...
  public TaskMode getMode() throws ServiceLocalException {
    return (TaskMode) this.getPropertyBag().getObjectFromPropertyDefinition(TaskSchema.Mode);
  }
  ...
  public TaskStatus getStatus() throws ServiceLocalException {
    return (TaskStatus) this.getPropertyBag().getObjectFromPropertyDefinition(TaskSchema.Status);
  }
  ...
  public void setStatus(TaskStatus value) throws Exception {
    this.getPropertyBag().setObjectFromPropertyDefinition(TaskSchema.Status, value);
  }
