...
public abstract class Strings {
  ...
  static {
    ...
    try (InputStream is = Thread.currentThread().getContextClassLoader().getResource("microsoft/exchange/webservices/data/Strings.properties").openStream()) {
      BUNDLE.load(is);
    } catch (Exception e) {
      LogFactory.getLog("ews").error("Could not load microsoft/exchange/webservices/data/Strings.properties");
    }
    loadProperties();
  }
