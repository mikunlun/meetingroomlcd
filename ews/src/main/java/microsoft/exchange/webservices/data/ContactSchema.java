...
public class ContactSchema extends ItemSchema {
  ...
  private static interface FieldUris {
     ...
     */
    String PhysicalAddressCountryOrRegion = "contacts:PhysicalAddress:CountryOrRegion";
     ...
     */
    String PhysicalAddressPostalCode = "contacts:PhysicalAddress:PostalCode";
   ...
   */
  public static final PropertyDefinition CompleteName = new ComplexPropertyDefinition<CompleteName>(CompleteName.class, XmlElementNames.CompleteName, FieldUris.CompleteName, EnumSet.of(PropertyDefinitionFlags.CanFind), ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<CompleteName>() {
    @Override
   ...
   */
  public static final PropertyDefinition EmailAddresses = new ComplexPropertyDefinition<EmailAddressDictionary>(EmailAddressDictionary.class, XmlElementNames.EmailAddresses, FieldUris.EmailAddresses, EnumSet.of(PropertyDefinitionFlags.AutoInstantiateOnRead, PropertyDefinitionFlags.CanSet, PropertyDefinitionFlags.CanUpdate), ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<EmailAddressDictionary>() {
    @Override
   ...
   */
  public static final PropertyDefinition PhysicalAddresses = new ComplexPropertyDefinition<PhysicalAddressDictionary>(PhysicalAddressDictionary.class, XmlElementNames.PhysicalAddresses, FieldUris.PhysicalAddresses, EnumSet.of(PropertyDefinitionFlags.AutoInstantiateOnRead, PropertyDefinitionFlags.CanSet, PropertyDefinitionFlags.CanUpdate), ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<PhysicalAddressDictionary>() {
    @Override
   ...
   */
  public static final PropertyDefinition PhoneNumbers = new ComplexPropertyDefinition<PhoneNumberDictionary>(PhoneNumberDictionary.class, XmlElementNames.PhoneNumbers, FieldUris.PhoneNumbers, EnumSet.of(PropertyDefinitionFlags.AutoInstantiateOnRead, PropertyDefinitionFlags.CanSet, PropertyDefinitionFlags.CanUpdate), ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<PhoneNumberDictionary>() {
    @Override
   ...
   */
  public static final PropertyDefinition Children = new ComplexPropertyDefinition<StringList>(StringList.class, XmlElementNames.Children, FieldUris.Children, EnumSet.of(PropertyDefinitionFlags.AutoInstantiateOnRead, PropertyDefinitionFlags.CanSet, PropertyDefinitionFlags.CanUpdate, PropertyDefinitionFlags.CanDelete, PropertyDefinitionFlags.CanFind), ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<StringList>() {
    @Override
   ...
   */
  public static final PropertyDefinition Companies = new ComplexPropertyDefinition<StringList>(StringList.class, XmlElementNames.Companies, FieldUris.Companies, EnumSet.of(PropertyDefinitionFlags.AutoInstantiateOnRead, PropertyDefinitionFlags.CanSet, PropertyDefinitionFlags.CanUpdate, PropertyDefinitionFlags.CanDelete, PropertyDefinitionFlags.CanFind), ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<StringList>() {
    @Override
    public StringList createComplexProperty() {
      return new StringList();
    }
   ...
   */
  public static final PropertyDefinition ContactSource = new GenericPropertyDefinition<ContactSource>(ContactSource.class, XmlElementNames.ContactSource, FieldUris.ContactSource, EnumSet.of(PropertyDefinitionFlags.CanFind), ExchangeVersion.Exchange2007_SP1);
   ...
   */
  public static final PropertyDefinition ImAddresses = new ComplexPropertyDefinition<ImAddressDictionary>(ImAddressDictionary.class, XmlElementNames.ImAddresses, FieldUris.ImAddresses, EnumSet.of(PropertyDefinitionFlags.AutoInstantiateOnRead, PropertyDefinitionFlags.CanSet, PropertyDefinitionFlags.CanUpdate), ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<ImAddressDictionary>() {
    @Override
   ...
   */
  public static final PropertyDefinition PostalAddressIndex = new GenericPropertyDefinition<PhysicalAddressIndex>(PhysicalAddressIndex.class, XmlElementNames.PostalAddressIndex, FieldUris.PostalAddressIndex, EnumSet.of(PropertyDefinitionFlags.CanSet, PropertyDefinitionFlags.CanUpdate, PropertyDefinitionFlags.CanDelete, PropertyDefinitionFlags.CanFind), ExchangeVersion.Exchange2007_SP1);
  ...
  public static final PropertyDefinition UserSMIMECertificate = new ComplexPropertyDefinition<ByteArrayArray>(ByteArrayArray.class, XmlElementNames.UserSMIMECertificate, FieldUris.UserSMIMECertificate, EnumSet.of(PropertyDefinitionFlags.CanFind), ExchangeVersion.Exchange2010_SP1, new ICreateComplexPropertyDelegate<ByteArrayArray>() {
    @Override
  ...
  public static PropertyDefinition MSExchangeCertificate = new ComplexPropertyDefinition<ByteArrayArray>(ByteArrayArray.class, XmlElementNames.MSExchangeCertificate, FieldUris.MSExchangeCertificate, EnumSet.of(PropertyDefinitionFlags.CanFind), ExchangeVersion.Exchange2010_SP1, new ICreateComplexPropertyDelegate<ByteArrayArray>() {
    @Override
    public ByteArrayArray createComplexProperty() {
      return new ByteArrayArray();
    }
  ...
  public static PropertyDefinition DirectoryId = new StringPropertyDefinition(XmlElementNames.DirectoryId, FieldUris.DirectoryId, EnumSet.of(PropertyDefinitionFlags.CanFind), ExchangeVersion.Exchange2010_SP1);

  /**
   * Defines ManagerMailbox Property **
   */

  public static PropertyDefinition ManagerMailbox = new ContainedPropertyDefinition<EmailAddress>(EmailAddress.class, XmlElementNames.ManagerMailbox, FieldUris.ManagerMailbox, XmlElementNames.Mailbox, EnumSet.of(PropertyDefinitionFlags.CanFind), ExchangeVersion.Exchange2010_SP1, new ICreateComplexPropertyDelegate<EmailAddress>() {
    @Override
  ...
  public static PropertyDefinition DirectReports = new ComplexPropertyDefinition<EmailAddressCollection>(EmailAddressCollection.class, XmlElementNames.DirectReports, FieldUris.DirectReports, EnumSet.of(PropertyDefinitionFlags.CanFind), ExchangeVersion.Exchange2010_SP1, new ICreateComplexPropertyDelegate<EmailAddressCollection>() {
    @Override
