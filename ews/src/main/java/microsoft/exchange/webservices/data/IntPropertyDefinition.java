...
class IntPropertyDefinition extends GenericPropertyDefinition<Integer> {
   ...
   */
  protected IntPropertyDefinition(String xmlElementName, String uri, ExchangeVersion version) {
   ...
   * @param version        The version.
   */
  protected IntPropertyDefinition(String xmlElementName, String uri, EnumSet<PropertyDefinitionFlags> flags, ExchangeVersion version) {
   ...
   *                       property.
   */
  protected IntPropertyDefinition(String xmlElementName, String uri, EnumSet<PropertyDefinitionFlags> flags, ExchangeVersion version, boolean isNullable) {
