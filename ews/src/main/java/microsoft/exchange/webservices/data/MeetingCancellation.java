...
public class MeetingCancellation extends MeetingMessage {
   ...
   */
  protected MeetingCancellation(ItemAttachment parentAttachment) throws Exception {
  ...
  public static MeetingCancellation bind(ExchangeService service, ItemId id) {
    return MeetingCancellation.bind(service, id, PropertySet.getFirstClassProperties());
  }
