...
public final class DelegateUserResponse extends ServiceResponse {
   ...
   */
  protected DelegateUserResponse(boolean readDelegateUser, DelegateUser delegateUser) {
    super();
  ...
  protected void readElementsFromXml(EwsServiceXmlReader reader) throws Exception {
    if (this.readDelegateUser) {
      ...
      this.delegateUser.loadFromXml(reader, XmlNamespace.Messages, reader.getLocalName());
    }
  }
