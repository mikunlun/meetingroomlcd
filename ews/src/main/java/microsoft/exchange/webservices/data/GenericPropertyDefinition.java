...
class GenericPropertyDefinition<TPropertyValue> extends TypedPropertyDefinition {
   ...
   */
  protected GenericPropertyDefinition(Class<TPropertyValue> cls, String xmlElementName, String uri, ExchangeVersion version) {
   ...
   * @param version        The version.
   */
  protected GenericPropertyDefinition(Class<TPropertyValue> cls, String xmlElementName, String uri, EnumSet<PropertyDefinitionFlags> flags, ExchangeVersion version) {
   ...
   */
  @Override
  protected Object parse(String value) throws InstantiationException, IllegalAccessException, ParseException {
