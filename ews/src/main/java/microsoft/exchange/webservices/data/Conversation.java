...
public class Conversation extends ServiceObject {
  ...
  public void disableAlwaysCategorizeItems(boolean processSynchronously) throws ServiceResponseException, IndexOutOfBoundsException, Exception {
    ArrayList<ConversationId> convArry = new ArrayList<ConversationId>();
    convArry.add(this.getId());
    this.getService().disableAlwaysCategorizeItemsInConversations(convArry, processSynchronously).
  ...
  public void moveItemsInConversation(FolderId contextFolderId, FolderId destinationFolderId) throws ServiceResponseException, IndexOutOfBoundsException, Exception {
    ...
    this.getService().moveItemsInConversations(f, contextFolderId, destinationFolderId).
            getResponseAtIndex(0).throwIfNecessary();
  }
  ...
  public void copyItemsInConversation(FolderId contextFolderId, FolderId destinationFolderId) throws ServiceResponseException, IndexOutOfBoundsException, Exception {
    ...
    this.getService().copyItemsInConversations(f, contextFolderId, destinationFolderId).
            getResponseAtIndex(0).throwIfNecessary();
  }
  ...
  public void setReadStateForItemsInConversation(FolderId contextFolderId, boolean isRead) throws ServiceResponseException, IndexOutOfBoundsException, Exception {
    ...
    this.getService().setReadStateForItemsInConversations(f, contextFolderId, isRead).
            getResponseAtIndex(0).throwIfNecessary();
  }
  ...
  public boolean getHasAttachments() throws ServiceLocalException {
    return ((Boolean) this.getPropertyBag().
            getObjectFromPropertyDefinition(ConversationSchema.HasAttachments)).booleanValue();
  }
  ...
  public boolean getGlobalHasAttachments() throws ServiceLocalException {
    return ((Boolean) this.getPropertyBag().
            getObjectFromPropertyDefinition(ConversationSchema.GlobalHasAttachments)).booleanValue();
  ...
  public int getMessageCount() throws ServiceLocalException {
    return ((Integer) this.getPropertyBag().
            getObjectFromPropertyDefinition(ConversationSchema.MessageCount)).intValue();
  }
  ...
  public int getGlobalMessageCount() throws ServiceLocalException {
    ...
    return ((Integer) this.getPropertyBag().
            getObjectFromPropertyDefinition(ConversationSchema.GlobalMessageCount)).intValue();
  ...
  public int getSize() throws ServiceLocalException {
    return ((Integer) this.getPropertyBag().
            getObjectFromPropertyDefinition(ConversationSchema.Size)).intValue();
  }
  ...
  public int getGlobalSize() throws ServiceLocalException {
    return ((Integer) this.getPropertyBag().
            getObjectFromPropertyDefinition(ConversationSchema.GlobalSize)).intValue();
  }
  ...
  public StringList getItemClasses() throws Exception {
    return (StringList) this.getPropertyBag().
            getObjectFromPropertyDefinition(ConversationSchema.ItemClasses);
  }
  ...
  public StringList getGlobalItemClasses() throws Exception {
    return (StringList) this.getPropertyBag().
            getObjectFromPropertyDefinition(ConversationSchema.GlobalItemClasses);
  ...
  public Importance getImportance() throws Exception {
    return (Importance) this.getPropertyBag().
            getObjectFromPropertyDefinition(ConversationSchema.Importance);
  }
  ...
  public Importance getGlobalImportance() throws Exception {
    return (Importance) this.getPropertyBag().
            getObjectFromPropertyDefinition(ConversationSchema.GlobalImportance);
  }
  ...
  public ItemIdCollection getItemIds() throws Exception {
    return (ItemIdCollection) this.getPropertyBag().
            getObjectFromPropertyDefinition(ConversationSchema.ItemIds);
  }
  ...
  public ItemIdCollection getGlobalItemIds() throws Exception {
    return (ItemIdCollection) this.getPropertyBag().
            getObjectFromPropertyDefinition(ConversationSchema.GlobalItemIds);
  }
