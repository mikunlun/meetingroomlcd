...
public class ContactGroupSchema extends ItemSchema {
   ...
   */
  public static final PropertyDefinition Members = new ComplexPropertyDefinition<GroupMemberCollection>(GroupMemberCollection.class, XmlElementNames.Members, FieldUris.Members, EnumSet.of(PropertyDefinitionFlags.AutoInstantiateOnRead, PropertyDefinitionFlags.CanSet, PropertyDefinitionFlags.CanUpdate), ExchangeVersion.Exchange2010, new ICreateComplexPropertyDelegate<GroupMemberCollection>() {
    @Override
