...
public class AlternateId extends AlternateIdBase {
  ...
  protected void writeAttributesToXml(EwsServiceXmlWriter writer) throws ServiceXmlSerializationException {
    ...
    writer.writeAttributeValue(XmlAttributeNames.Mailbox, this.getMailbox());
  ...
  protected void loadAttributesFromXml(EwsServiceXmlReader reader) throws Exception {
    ...
    if (!(isArchive == null || isArchive.isEmpty())) {
      this.isArchive = reader.readAttributeValue(Boolean.class, XmlAttributeNames.IsArchive);
    } else {
