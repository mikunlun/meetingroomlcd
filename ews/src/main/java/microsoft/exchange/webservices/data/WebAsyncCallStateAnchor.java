...
public class WebAsyncCallStateAnchor {
   ...
   * Construtctor
   */
  public WebAsyncCallStateAnchor(ServiceRequestBase serviceRequest, HttpWebRequest webRequest, AsyncCallback asyncCallback, Object asyncState) throws Exception {
