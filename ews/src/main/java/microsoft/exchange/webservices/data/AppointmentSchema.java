...
public class AppointmentSchema extends ItemSchema {
   ...
   */
  public static final PropertyDefinition LegacyFreeBusyStatus = new GenericPropertyDefinition<LegacyFreeBusyStatus>(LegacyFreeBusyStatus.class, XmlElementNames.LegacyFreeBusyStatus, FieldUris.LegacyFreeBusyStatus, EnumSet.of(PropertyDefinitionFlags.CanSet, PropertyDefinitionFlags.CanUpdate, PropertyDefinitionFlags.CanFind), ExchangeVersion.Exchange2007_SP1);

  // Defines the Location property.
  /**
   * The Constant Location.
   */
  public static final PropertyDefinition Location = new StringPropertyDefinition(XmlElementNames.Location, FieldUris.Location, EnumSet.of(PropertyDefinitionFlags.CanSet, PropertyDefinitionFlags.CanUpdate, PropertyDefinitionFlags.CanDelete, PropertyDefinitionFlags.CanFind), ExchangeVersion.Exchange2007_SP1);
   ...
   */
  public static final PropertyDefinition AppointmentType = new GenericPropertyDefinition<AppointmentType>(AppointmentType.class, XmlElementNames.CalendarItemType, FieldUris.CalendarItemType, EnumSet.of(PropertyDefinitionFlags.CanFind), ExchangeVersion.Exchange2007_SP1);

  // Defines the MyResponseType property.
  /**
   * The Constant MyResponseType.
   */
  public static final PropertyDefinition MyResponseType = new GenericPropertyDefinition<MeetingResponseType>(MeetingResponseType.class, XmlElementNames.MyResponseType, FieldUris.MyResponseType, EnumSet.of(PropertyDefinitionFlags.CanSet, PropertyDefinitionFlags.CanUpdate, PropertyDefinitionFlags.CanFind), ExchangeVersion.Exchange2007_SP1);

  // Defines the Organizer property.
  /**
   * The Constant Organizer.
   */
  public static final PropertyDefinition Organizer = new ContainedPropertyDefinition<EmailAddress>(EmailAddress.class, XmlElementNames.Organizer, FieldUris.Organizer, XmlElementNames.Mailbox, EnumSet.of(PropertyDefinitionFlags.CanFind), ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<EmailAddress>() {
   ...
   */
  public static final PropertyDefinition RequiredAttendees = new ComplexPropertyDefinition<AttendeeCollection>(AttendeeCollection.class, XmlElementNames.RequiredAttendees, FieldUris.RequiredAttendees, EnumSet.of(PropertyDefinitionFlags.AutoInstantiateOnRead, PropertyDefinitionFlags.CanSet, PropertyDefinitionFlags.CanUpdate, PropertyDefinitionFlags.CanDelete), ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<AttendeeCollection>() {
   ...
   */
  public static final PropertyDefinition OptionalAttendees = new ComplexPropertyDefinition<AttendeeCollection>(AttendeeCollection.class, XmlElementNames.OptionalAttendees, FieldUris.OptionalAttendees, EnumSet.of(PropertyDefinitionFlags.AutoInstantiateOnRead, PropertyDefinitionFlags.CanSet, PropertyDefinitionFlags.CanUpdate, PropertyDefinitionFlags.CanDelete), ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<AttendeeCollection>() {
    public AttendeeCollection createComplexProperty() {
      return new AttendeeCollection();
    }
  });
   ...
   */
  public static final PropertyDefinition Resources = new ComplexPropertyDefinition<AttendeeCollection>(AttendeeCollection.class, XmlElementNames.Resources, FieldUris.Resources, EnumSet.of(PropertyDefinitionFlags.AutoInstantiateOnRead, PropertyDefinitionFlags.CanSet, PropertyDefinitionFlags.CanUpdate, PropertyDefinitionFlags.CanDelete), ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<AttendeeCollection>() {
    public AttendeeCollection createComplexProperty() {
      return new AttendeeCollection();
    }
  });
   ...
   */
  public static final PropertyDefinition ConflictingMeetings = new ComplexPropertyDefinition<ItemCollection<Appointment>>(XmlElementNames.ConflictingMeetings, FieldUris.ConflictingMeetings, ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<ItemCollection<Appointment>>() {
   ...
   */
  public static final PropertyDefinition AdjacentMeetings = new ComplexPropertyDefinition<ItemCollection<Appointment>>(XmlElementNames.AdjacentMeetings, FieldUris.AdjacentMeetings, ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<ItemCollection<Appointment>>() {
    public ItemCollection<Appointment> createComplexProperty() {
      return new ItemCollection<Appointment>();
    }
  });
   ...
   */
  public static final PropertyDefinition TimeZone = new StringPropertyDefinition(XmlElementNames.TimeZone, FieldUris.TimeZone, EnumSet.of(PropertyDefinitionFlags.CanFind), ExchangeVersion.Exchange2007_SP1);
   ...
   */
  public static final PropertyDefinition FirstOccurrence = new ComplexPropertyDefinition<OccurrenceInfo>(OccurrenceInfo.class, XmlElementNames.FirstOccurrence, FieldUris.FirstOccurrence, ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<OccurrenceInfo>() {
   ...
   */
  public static final PropertyDefinition LastOccurrence = new ComplexPropertyDefinition<OccurrenceInfo>(OccurrenceInfo.class, XmlElementNames.LastOccurrence, FieldUris.LastOccurrence, ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<OccurrenceInfo>() {
    public OccurrenceInfo createComplexProperty() {
      return new OccurrenceInfo();
    }
  });
   ...
   */
  public static final PropertyDefinition ModifiedOccurrences = new ComplexPropertyDefinition<OccurrenceInfoCollection>(OccurrenceInfoCollection.class, XmlElementNames.ModifiedOccurrences, FieldUris.ModifiedOccurrences, ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<OccurrenceInfoCollection>() {
   ...
   */
  public static final PropertyDefinition DeletedOccurrences = new ComplexPropertyDefinition<DeletedOccurrenceInfoCollection>(DeletedOccurrenceInfoCollection.class, XmlElementNames.DeletedOccurrences, FieldUris.DeletedOccurrences, ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<DeletedOccurrenceInfoCollection>() {
   ...
   */
  protected static final PropertyDefinition MeetingTimeZone = new MeetingTimeZonePropertyDefinition(XmlElementNames.MeetingTimeZone, FieldUris.MeetingTimeZone, EnumSet.of(PropertyDefinitionFlags.CanSet, PropertyDefinitionFlags.CanUpdate), ExchangeVersion.Exchange2007_SP1);
   ...
   */
  public static final PropertyDefinition ICalDateTimeStamp = new DateTimePropertyDefinition(XmlElementNames.DateTimeStamp, FieldUris.DateTimeStamp, EnumSet.of(PropertyDefinitionFlags.CanFind), ExchangeVersion.Exchange2007_SP1, true); // isNullable
