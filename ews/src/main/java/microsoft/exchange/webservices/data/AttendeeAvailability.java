...
public final class AttendeeAvailability extends ServiceResponse {
   ...
   */
  protected void loadFreeBusyViewFromXml(EwsServiceXmlReader reader, FreeBusyViewType viewType) throws Exception {
    ...
    do {
      ...
      if (reader.isStartElement()) {
        if (reader.getLocalName().equals(XmlElementNames.MergedFreeBusy)) {
        ...
        } else if (reader.getLocalName().equals(XmlElementNames.CalendarEventArray)) {
          do {
            reader.read();
        ...
        } else if (reader.getLocalName().equals(XmlElementNames.WorkingHours)) {
