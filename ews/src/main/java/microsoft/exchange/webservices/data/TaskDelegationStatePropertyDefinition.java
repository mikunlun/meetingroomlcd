 ...
 */
final class TaskDelegationStatePropertyDefinition extends GenericPropertyDefinition<TaskDelegationState> {
  /**
   * The No match.
   */
  ...
  protected Object parse(String value) {
    switch (Status.valueOf(value)) {
      ...
      default:
        EwsUtilities.EwsAssert(false, "TaskDelegationStatePropertyDefinition.Parse", String.format("TaskDelegationStatePropertyDefinition." +
                "Parse():" +
