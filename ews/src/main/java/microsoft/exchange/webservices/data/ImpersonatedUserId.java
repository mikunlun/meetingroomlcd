...
public final class ImpersonatedUserId {
  ...
  protected void writeToXml(EwsServiceXmlWriter writer) throws Exception {
    ...
    String connectingIdTypeLocalName = (this.idType == ConnectingIdType.SmtpAddress) && (writer.getService().getRequestedServerVersion() == ExchangeVersion.Exchange2007_SP1) ? XmlElementNames.PrimarySmtpAddress : this.getIdType().toString();
