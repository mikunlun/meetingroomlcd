...
class CancelMeetingMessageSchema extends ServiceObjectSchema {
   ...
   * The Constant Body.
   */
  public static final PropertyDefinition Body = new ComplexPropertyDefinition<MessageBody>(MessageBody.class, XmlElementNames.NewBodyContent, EnumSet.of(PropertyDefinitionFlags.CanSet), ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<MessageBody>() {
   ...
   */
  static final CancelMeetingMessageSchema Instance = new CancelMeetingMessageSchema();
