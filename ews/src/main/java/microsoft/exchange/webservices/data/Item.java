...
public class Item extends ServiceObject {
  ...
  protected boolean getIsTimeZoneHeaderRequired(boolean isUpdateOperation) throws Exception {
    ...
    if (!isUpdateOperation && (this.getService().getRequestedServerVersion().ordinal() >= ExchangeVersion.Exchange2010_SP2.ordinal())) {
      ...
      ListIterator<Attachment> items = this.getAttachments().getItems().listIterator();

      while (items.hasNext()) {

        ItemAttachment itemAttachment = (ItemAttachment) items.next();

        if ((itemAttachment.getItem() != null) && itemAttachment.getItem().getIsTimeZoneHeaderRequired(false /* isUpdateOperation */)) {
          return true;
        }
      }
    }
  ...
  public Sensitivity getSensitivity() throws ServiceLocalException {
    return (Sensitivity) this.getPropertyBag().getObjectFromPropertyDefinition(ItemSchema.Sensitivity);
  }
  ...
  public int getSize() throws ServiceLocalException {
    return ((Integer) this.getPropertyBag().getObjectFromPropertyDefinition(ItemSchema.Size)).intValue();
  }
  ...
  public Importance getImportance() throws ServiceLocalException {
    return (Importance) this.getPropertyBag().getObjectFromPropertyDefinition(ItemSchema.Importance);
  }
  ...
  public boolean getIsSubmitted() throws ServiceLocalException {
    return ((Boolean) this.getPropertyBag().getObjectFromPropertyDefinition(ItemSchema.IsSubmitted)).booleanValue();
  }
  ...
  public boolean getIsAssociated() throws ServiceLocalException {
    return ((Boolean) this.getPropertyBag().getObjectFromPropertyDefinition(ItemSchema.IsAssociated)).booleanValue();
  }
  ...
  public boolean getIsDraft() throws ServiceLocalException {
    return ((Boolean) this.getPropertyBag().getObjectFromPropertyDefinition(ItemSchema.IsDraft)).booleanValue();
  }
  ...
  public boolean getIsFromMe() throws ServiceLocalException {
    return ((Boolean) this.getPropertyBag().getObjectFromPropertyDefinition(ItemSchema.IsFromMe)).booleanValue();
  }
  ...
  public boolean getIsResend() throws ServiceLocalException {
    return ((Boolean) this.getPropertyBag().getObjectFromPropertyDefinition(ItemSchema.IsResend)).booleanValue();
  }
  ...
  public boolean getIsUnmodified() throws ServiceLocalException {
    return ((Boolean) this.getPropertyBag().getObjectFromPropertyDefinition(ItemSchema.IsUnmodified)).booleanValue();
  ...
  public EnumSet<ResponseActions> getAllowedResponseActions() throws ServiceLocalException {
    return (EnumSet<ResponseActions>) this.getPropertyBag().getObjectFromPropertyDefinition(ItemSchema.AllowedResponseActions);
  }
  ...
  public boolean getIsReminderSet() throws ServiceLocalException {
    return ((Boolean) this.getPropertyBag().getObjectFromPropertyDefinition(ItemSchema.IsReminderSet)).booleanValue();
  }
  ...
  public int getReminderMinutesBeforeStart() throws ServiceLocalException {
    return ((Integer) this.getPropertyBag().getObjectFromPropertyDefinition(ItemSchema.ReminderMinutesBeforeStart)).intValue();
  }
  ...
  public boolean getHasAttachments() throws ServiceLocalException {
    return ((Boolean) this.getPropertyBag().getObjectFromPropertyDefinition(ItemSchema.HasAttachments)).booleanValue();
  }
  ...
  public EnumSet<EffectiveRights> getEffectiveRights() throws ServiceLocalException {
    return (EnumSet<EffectiveRights>) this.getPropertyBag().getObjectFromPropertyDefinition(ItemSchema.EffectiveRights);
  }
