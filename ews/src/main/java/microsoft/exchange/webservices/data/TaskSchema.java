...
public class TaskSchema extends ItemSchema {
  ...
  private static class FieldUris {
     ...
     */
    public final static String BillingInformation = "task:BillingInformation";
     ...
     */
    public final static String IsAssignmentEditable = "task:IsAssignmentEditable";
   ...
   */
  public static final PropertyDefinition ActualWork = new IntPropertyDefinition(XmlElementNames.ActualWork, FieldUris.ActualWork, EnumSet.of(PropertyDefinitionFlags.CanSet, PropertyDefinitionFlags.CanUpdate, PropertyDefinitionFlags.CanDelete, PropertyDefinitionFlags.CanFind), ExchangeVersion.Exchange2007_SP1,
   ...
   */
  public static final PropertyDefinition Contacts = new ComplexPropertyDefinition<StringList>(StringList.class, XmlElementNames.Contacts, FieldUris.Contacts, EnumSet.of(PropertyDefinitionFlags.AutoInstantiateOnRead, PropertyDefinitionFlags.CanSet, PropertyDefinitionFlags.CanUpdate, PropertyDefinitionFlags.CanDelete, PropertyDefinitionFlags.CanFind), ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<StringList>() {
    public StringList createComplexProperty() {
      return new StringList();
    }
   ...
   */
  public static final PropertyDefinition Mode = new GenericPropertyDefinition<TaskMode>(TaskMode.class, XmlElementNames.IsAssignmentEditable, FieldUris.IsAssignmentEditable, EnumSet.of(PropertyDefinitionFlags.CanFind), ExchangeVersion.Exchange2007_SP1);
   ...
   */
  public static final PropertyDefinition Status = new GenericPropertyDefinition<TaskStatus>(TaskStatus.class, XmlElementNames.Status, FieldUris.Status, EnumSet.of(PropertyDefinitionFlags.CanSet, PropertyDefinitionFlags.CanUpdate, PropertyDefinitionFlags.CanFind), ExchangeVersion.Exchange2007_SP1);
