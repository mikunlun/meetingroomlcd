...
final class BoolPropertyDefinition extends GenericPropertyDefinition<Boolean> {
   ...
   */
  protected BoolPropertyDefinition(String xmlElementName, String uri, ExchangeVersion version) {
   ...
   * @param version        The version.
   */
  protected BoolPropertyDefinition(String xmlElementName, String uri, EnumSet<PropertyDefinitionFlags> flags, ExchangeVersion version) {
   ...
   *                       property.
   */
  protected BoolPropertyDefinition(String xmlElementName, String uri, EnumSet<PropertyDefinitionFlags> flags, ExchangeVersion version, boolean isNullable) {
