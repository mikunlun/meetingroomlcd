...
public class RecurrencePropertyDefinition extends PropertyDefinition {
  ...
  protected void loadPropertyValueFromXml(EwsServiceXmlReader reader, PropertyBag propertyBag) throws Exception {
    ...
    if (reader.getLocalName().equals(XmlElementNames.RelativeYearlyRecurrence)) {

      recurrence = new Recurrence.RelativeYearlyPattern();
    } else if (reader.getLocalName().equals(XmlElementNames.AbsoluteYearlyRecurrence)) {

      recurrence = new Recurrence.YearlyPattern();
    } else if (reader.getLocalName().equals(XmlElementNames.RelativeMonthlyRecurrence)) {

      recurrence = new Recurrence.RelativeMonthlyPattern();
    } else if (reader.getLocalName().equals(XmlElementNames.AbsoluteMonthlyRecurrence)) {

      recurrence = new Recurrence.MonthlyPattern();
    } else if (reader.getLocalName().equals(XmlElementNames.DailyRecurrence)) {

      recurrence = new Recurrence.DailyPattern();
    } else if (reader.getLocalName().equals(XmlElementNames.DailyRegeneration)) {

      recurrence = new Recurrence.DailyRegenerationPattern();
    } else if (reader.getLocalName().equals(XmlElementNames.WeeklyRecurrence)) {

      recurrence = new Recurrence.WeeklyPattern();
    } else if (reader.getLocalName().equals(XmlElementNames.WeeklyRegeneration)) {

      recurrence = new Recurrence.WeeklyRegenerationPattern();
    } else if (reader.getLocalName().equals(XmlElementNames.MonthlyRegeneration)) {

      recurrence = new Recurrence.MonthlyRegenerationPattern();
    } else if (reader.getLocalName().equals(XmlElementNames.YearlyRegeneration)) {
    ...
    } else if (reader.getLocalName().equals(XmlElementNames.EndDateRecurrence)) {

      range = new EndDateRecurrenceRange();
    } else if (reader.getLocalName().equals(XmlElementNames.NumberedRecurrence)) {
