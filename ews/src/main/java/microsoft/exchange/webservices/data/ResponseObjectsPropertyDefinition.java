...
public class ResponseObjectsPropertyDefinition extends PropertyDefinition {
   ...
   */
  protected ResponseObjectsPropertyDefinition(String xmlElementName, String uri, ExchangeVersion version) {
   ...
   */
  protected final void loadPropertyValueFromXml(EwsServiceXmlReader reader, PropertyBag propertyBag) throws Exception {
    ...
    if (!reader.isEmptyElement()) {
      do {
        ...
        if (reader.isStartElement()) {
          ...
          if (reader.getLocalName().equals(XmlElementNames.AcceptItem)) {

            value.add(ResponseActions.Accept);
          } else if (reader.getLocalName().equals(XmlElementNames.TentativelyAcceptItem)) {

            value.add(ResponseActions.TentativelyAccept);
          } else if (reader.getLocalName().equals(XmlElementNames.DeclineItem)) {

            value.add(ResponseActions.Decline);
          } else if (reader.getLocalName().equals(XmlElementNames.ReplyToItem)) {

            value.add(ResponseActions.Reply);
          } else if (reader.getLocalName().equals(XmlElementNames.ForwardItem)) {

            value.add(ResponseActions.Forward);
          } else if (reader.getLocalName().equals(XmlElementNames.ReplyAllToItem)) {

            value.add(ResponseActions.ReplyAll);
          } else if (reader.getLocalName().equals(XmlElementNames.CancelCalendarItem)) {

            value.add(ResponseActions.Cancel);
          } else if (reader.getLocalName().equals(XmlElementNames.RemoveItem)) {

            value.add(ResponseActions.RemoveFromCalendar);
          } else if (reader.getLocalName().equals(XmlElementNames.SuppressReadReceipt)) {

            value.add(ResponseActions.SuppressReadReceipt);
          } else if (reader.getLocalName().equals(XmlElementNames.PostReplyItem)) {
   ...
   */
  protected void writePropertyValueToXml(EwsServiceXmlWriter writer, PropertyBag propertyBag, boolean isUpdateOperation) {
