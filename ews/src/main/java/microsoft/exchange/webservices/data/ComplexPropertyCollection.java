...
public abstract class ComplexPropertyCollection<TComplexProperty extends ComplexProperty> extends ComplexProperty implements ICustomXmlUpdateSerializer, Iterable<TComplexProperty>, IComplexPropertyChangedDelegate {
  ...
  protected void itemChanged(ComplexProperty complexProperty) {
    EwsUtilities.EwsAssert(complexProperty instanceof ComplexProperty, "ComplexPropertyCollection.ItemChanged", String.format("ComplexPropertyCollection." +
      ...
      do {
        ...
        if (reader.isStartElement()) {
          ...
          if (complexProperty != null) {
            complexProperty.loadFromXml(reader, reader.getLocalName());
