...
public class EmailMessageSchema extends ItemSchema {
  ...
  private static interface FieldUris {
     ...
     */
    String IsDeliveryReceiptRequested = "message:IsDeliveryReceiptRequested";
   ...
   */
  public static final PropertyDefinition ToRecipients = new ComplexPropertyDefinition<EmailAddressCollection>(EmailAddressCollection.class, XmlElementNames.ToRecipients, FieldUris.ToRecipients, EnumSet.of(PropertyDefinitionFlags.AutoInstantiateOnRead, PropertyDefinitionFlags.CanSet, PropertyDefinitionFlags.CanUpdate, PropertyDefinitionFlags.CanDelete), ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<EmailAddressCollection>() {
    @Override
   ...
   */
  public static final PropertyDefinition BccRecipients = new ComplexPropertyDefinition<EmailAddressCollection>(EmailAddressCollection.class, XmlElementNames.BccRecipients, FieldUris.BccRecipients, EnumSet.of(PropertyDefinitionFlags.AutoInstantiateOnRead, PropertyDefinitionFlags.CanSet, PropertyDefinitionFlags.CanUpdate, PropertyDefinitionFlags.CanDelete), ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<EmailAddressCollection>() {
    @Override
    public EmailAddressCollection createComplexProperty() {
      return new EmailAddressCollection();
    }
   ...
   */
  public static final PropertyDefinition CcRecipients = new ComplexPropertyDefinition<EmailAddressCollection>(EmailAddressCollection.class, XmlElementNames.CcRecipients, FieldUris.CcRecipients, EnumSet.of(PropertyDefinitionFlags.AutoInstantiateOnRead, PropertyDefinitionFlags.CanSet, PropertyDefinitionFlags.CanUpdate, PropertyDefinitionFlags.CanDelete), ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<EmailAddressCollection>() {
    @Override
    public EmailAddressCollection createComplexProperty() {
      return new EmailAddressCollection();
    }
   ...
   */
  public static final PropertyDefinition ReplyTo = new ComplexPropertyDefinition<EmailAddressCollection>(EmailAddressCollection.class, XmlElementNames.ReplyTo, FieldUris.ReplyTo, EnumSet.of(PropertyDefinitionFlags.AutoInstantiateOnRead, PropertyDefinitionFlags.CanSet, PropertyDefinitionFlags.CanUpdate, PropertyDefinitionFlags.CanDelete), ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<EmailAddressCollection>() {
    @Override
    public EmailAddressCollection createComplexProperty() {
      return new EmailAddressCollection();
    }
   ...
   */
  public static final PropertyDefinition Sender = new ContainedPropertyDefinition<EmailAddress>(EmailAddress.class, XmlElementNames.Sender, FieldUris.Sender, XmlElementNames.Mailbox, EnumSet.of(PropertyDefinitionFlags.CanSet, PropertyDefinitionFlags.CanFind), ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<EmailAddress>() {
    @Override
    public EmailAddress createComplexProperty() {
      return new EmailAddress();
    }
   ...
   */
  public static final PropertyDefinition ReceivedBy = new ContainedPropertyDefinition<EmailAddress>(EmailAddress.class, XmlElementNames.ReceivedBy, FieldUris.ReceivedBy, XmlElementNames.Mailbox, EnumSet.of(PropertyDefinitionFlags.CanFind), ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<EmailAddress>() {
    @Override
    public EmailAddress createComplexProperty() {
      return new EmailAddress();
    }
   ...
   */
  public static final PropertyDefinition ReceivedRepresenting = new ContainedPropertyDefinition<EmailAddress>(EmailAddress.class, XmlElementNames.ReceivedRepresenting, FieldUris.ReceivedRepresenting, XmlElementNames.Mailbox, EnumSet.of(PropertyDefinitionFlags.CanFind), ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<EmailAddress>() {
    @Override
    public EmailAddress createComplexProperty() {
      return new EmailAddress();
    }
   ...
   */
  protected static final EmailMessageSchema Instance = new EmailMessageSchema();
