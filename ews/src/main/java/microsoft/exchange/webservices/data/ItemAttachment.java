...
public class ItemAttachment extends Attachment implements IServiceObjectChangedDelegate {
  ...
  protected boolean tryReadElementFromXmlToPatch(EwsServiceXmlReader reader) throws Exception {
    ...
    reader.read();
    Class itemClass = EwsUtilities.getItemTypeFromXmlElementName(reader.getLocalName().toString());
  ...
  public void load(PropertyDefinitionBase... additionalProperties) throws Exception {
    List<PropertyDefinitionBase> addProp = new ArrayList<PropertyDefinitionBase>();
