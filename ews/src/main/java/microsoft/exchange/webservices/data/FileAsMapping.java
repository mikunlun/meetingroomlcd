...
public enum FileAsMapping {
   ...
   * The Given name.
   */
  @RequiredServerVersion(version = ExchangeVersion.Exchange2010) @EwsEnum(schemaName = "FirstName")
  GivenName,
   ...
   */
  @RequiredServerVersion(version = ExchangeVersion.Exchange2010) @EwsEnum(schemaName = "LastFirstMiddleSuffix")
   ...
   * The Surname.
   */
  @RequiredServerVersion(version = ExchangeVersion.Exchange2010) @EwsEnum(schemaName = "LastName")
  Surname,
