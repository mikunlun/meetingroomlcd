...
public final class DelegatePermissions extends ComplexProperty {
  ...
  protected DelegatePermissions() {
    super();
    this.delegateFolderPermissions = new HashMap<String, DelegateFolderPermission>();

    delegateFolderPermissions.put(XmlElementNames.CalendarFolderPermissionLevel, new DelegateFolderPermission());
    delegateFolderPermissions.put(XmlElementNames.TasksFolderPermissionLevel, new DelegateFolderPermission());
    delegateFolderPermissions.put(XmlElementNames.InboxFolderPermissionLevel, new DelegateFolderPermission());
    delegateFolderPermissions.put(XmlElementNames.ContactsFolderPermissionLevel, new DelegateFolderPermission());
    delegateFolderPermissions.put(XmlElementNames.NotesFolderPermissionLevel, new DelegateFolderPermission());
    delegateFolderPermissions.put(XmlElementNames.JournalFolderPermissionLevel, new DelegateFolderPermission());
  }
  ...
  public DelegateFolderPermissionLevel getContactsFolderPermissionLevel() {
    return this.delegateFolderPermissions.get(XmlElementNames.ContactsFolderPermissionLevel).
            getPermissionLevel();
  }
  ...
  public void setContactsFolderPermissionLevel(DelegateFolderPermissionLevel value) {
    this.delegateFolderPermissions.get(XmlElementNames.ContactsFolderPermissionLevel).
            setPermissionLevel(value);
  }
  ...
  private void writePermissionToXml(EwsServiceXmlWriter writer, String xmlElementName) throws ServiceXmlSerializationException, XMLStreamException {
    DelegateFolderPermissionLevel delegateFolderPermissionLevel = this.delegateFolderPermissions.
