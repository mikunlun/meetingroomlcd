 ...
 */
final class FindItemRequest<TItem extends Item> extends FindRequest<FindItemResponse<TItem>> {
   ...
   * @throws Exception
   */
  protected FindItemRequest(ExchangeService service, ServiceErrorHandling errorHandlingMode) throws Exception {
  ...
  protected FindItemResponse<TItem> createServiceResponse(ExchangeService service, int responseIndex) {
    return new FindItemResponse<TItem>(this.getGroupBy() != null, this.getView().getPropertySetOrDefault());
  }
