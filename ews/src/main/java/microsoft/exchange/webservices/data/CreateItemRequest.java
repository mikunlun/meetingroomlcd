 ...
 */
final class CreateItemRequest extends CreateItemRequestBase<Item, ServiceResponse> {
   ...
   * @throws Exception
   */
  protected CreateItemRequest(ExchangeService service, ServiceErrorHandling errorHandlingMode) throws Exception {
  ...
  protected ServiceResponse createServiceResponse(ExchangeService service, int responseIndex) {
    return new CreateItemResponse((Item) EwsUtilities.getEnumeratedObjectAt(this.getItems(), responseIndex));
  }
