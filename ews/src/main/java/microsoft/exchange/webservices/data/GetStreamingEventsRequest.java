...
class GetStreamingEventsRequest extends HangingServiceRequestBase {
   ...
   */
  protected GetStreamingEventsRequest(ExchangeService service, IHandleResponseObject serviceObjectHandler, Iterable<String> subscriptionIds, int connectionTimeout) throws ServiceVersionException {
