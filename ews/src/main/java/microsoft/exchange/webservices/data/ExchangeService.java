...
public final class ExchangeService extends ExchangeServiceBase implements IAutodiscoverRedirectionUrl {
  ...
  public FindFoldersResults findFolders(FolderId parentFolderId, FolderView view) throws Exception {
    ...
    ServiceResponseCollection<FindFolderResponse> responses = this.internalFindFolders(folderIdArray, null, /* searchFilter */
  ...
  protected void createItem(Item item, FolderId parentFolderId, MessageDisposition messageDisposition, SendInvitationsMode sendInvitationsMode) throws Exception {
    ...
    items.add(item);
    internalCreateItems(items, parentFolderId, messageDisposition, sendInvitationsMode, ServiceErrorHandling.ThrowOnError);
  }
   ...
   * @throws Exception the exception
   */
  protected Item copyItem(ItemId itemId, FolderId destinationFolderId) throws Exception {
   ...
   * @throws Exception the exception
   */
  protected Item moveItem(ItemId itemId, FolderId destinationFolderId) throws Exception {
    List<ItemId> itemIdArray = new ArrayList<ItemId>();
    itemIdArray.add(itemId);
  ...
  public FindItemsResults<Item> findItems(FolderId parentFolderId, SearchFilter searchFilter, ItemView view) throws Exception {
    ...
    List folderIdArray = new ArrayList();
    folderIdArray.add(parentFolderId);
    ServiceResponseCollection<FindItemResponse<Item>> responses = this.findItems(folderIdArray, searchFilter, null, /* queryString */
            view, null, /* groupBy */
            ServiceErrorHandling.ThrowOnError);
  ...
  public PullSubscription subscribeToPullNotifications(Iterable<FolderId> folderIds, int timeout, String watermark, EventType... eventTypes) throws Exception {
    ...
    return this.buildSubscribeToPullNotificationsRequest(folderIds, timeout, watermark, eventTypes).execute().getResponseAtIndex(0).getSubscription();
  }
  ...
  public AsyncRequestResult beginSubscribeToPullNotifications(AsyncCallback callback, Object state, Iterable<FolderId> folderIds, int timeout, String watermark, EventType... eventTypes) throws Exception {
    ...
    return this.buildSubscribeToPullNotificationsRequest(folderIds, timeout, watermark, eventTypes).beginExecute(callback, null);
  }
  ...
  public PullSubscription subscribeToPullNotificationsOnAllFolders(int timeout, String watermark, EventType... eventTypes) throws Exception {
    ...
    return this.buildSubscribeToPullNotificationsRequest(null, timeout, watermark, eventTypes).execute().getResponseAtIndex(0).getSubscription();
  }
  ...
  public IAsyncResult beginSubscribeToPullNotificationsOnAllFolders(AsyncCallback callback, Object state, int timeout, String watermark, EventType... eventTypes) throws Exception {
    ...
    return this.buildSubscribeToPullNotificationsRequest(null, timeout, watermark, eventTypes).beginExecute(null, null);
  }
  ...
  protected IAsyncResult beginUnsubscribe(AsyncCallback callback, Object state, String subscriptionId) throws Exception {
    return this.buildUnsubscribeRequest(subscriptionId).beginExecute(callback, null);
  }
   ...
   * @throws Exception
   */
  protected IAsyncResult beginGetEvents(AsyncCallback callback, Object state, String subscriptionId, String watermark) throws Exception {
    return this.buildGetEventsRequest(subscriptionId, watermark).beginExecute(callback, null);
  }
  ...
  public PushSubscription subscribeToPushNotifications(Iterable<FolderId> folderIds, URI url, int frequency, String watermark, EventType... eventTypes) throws Exception {
    ...
    return this.buildSubscribeToPushNotificationsRequest(folderIds, url, frequency, watermark, eventTypes).execute().getResponseAtIndex(0).getSubscription();
  }
  ...
  public IAsyncResult beginSubscribeToPushNotifications(AsyncCallback callback, Object state, Iterable<FolderId> folderIds, URI url, int frequency, String watermark, EventType... eventTypes) throws Exception {
    ...
    return this.buildSubscribeToPushNotificationsRequest(folderIds, url, frequency, watermark, eventTypes).beginExecute(callback, null);
  }
  ...
  public PushSubscription subscribeToPushNotificationsOnAllFolders(URI url, int frequency, String watermark, EventType... eventTypes) throws Exception {
    ...
    return this.buildSubscribeToPushNotificationsRequest(null, url, frequency, watermark, eventTypes).execute().getResponseAtIndex(0).getSubscription();
  }
  ...
  public IAsyncResult beginSubscribeToPushNotificationsOnAllFolders(AsyncCallback callback, Object state, URI url, int frequency, String watermark, EventType... eventTypes) throws Exception {
    ...
    return this.buildSubscribeToPushNotificationsRequest(null, url, frequency, watermark, eventTypes).beginExecute(callback, null);
  }
  ...
  public StreamingSubscription subscribeToStreamingNotifications(Iterable<FolderId> folderIds, EventType... eventTypes) throws Exception {
    ...
    return this.buildSubscribeToStreamingNotificationsRequest(folderIds, eventTypes).execute().getResponseAtIndex(0).getSubscription();
  }
  ...
  public StreamingSubscription subscribeToStreamingNotificationsOnAllFolders(EventType... eventTypes) throws Exception {
    ...
    return this.buildSubscribeToStreamingNotificationsRequest(null, eventTypes).execute().getResponseAtIndex(0).getSubscription();
  }
...
/*	public StreamingSubscription subscribeToStreamingNotifications(
  ...
  public IAsyncResult beginSubscribeToStreamingNotifications(AsyncCallback callback, Object state, Iterable<FolderId> folderIds, EventType... eventTypes) throws Exception {
    ...
    return this.buildSubscribeToStreamingNotificationsRequest(folderIds, eventTypes).beginExecute(callback, null);
  }
  ...
  public IAsyncResult beginSubscribeToStreamingNotificationsOnAllFolders(AsyncCallback callback, Object state, EventType... eventTypes) throws Exception {
    ...
    return this.buildSubscribeToStreamingNotificationsRequest(null, eventTypes).beginExecute(callback, null);
  }
  ...
  public ChangeCollection<ItemChange> syncFolderItems(FolderId syncFolderId, PropertySet propertySet, Iterable<ItemId> ignoredItemIds, int maxChangesReturned, SyncFolderItemsScope syncScope, String syncState) throws Exception {
    return this.buildSyncFolderItemsRequest(syncFolderId, propertySet, ignoredItemIds, maxChangesReturned, syncScope, syncState).execute().getResponseAtIndex(0).getChanges();
  }
  ...
  public IAsyncResult beginSyncFolderItems(AsyncCallback callback, Object state, FolderId syncFolderId, PropertySet propertySet, Iterable<ItemId> ignoredItemIds, int maxChangesReturned, SyncFolderItemsScope syncScope, String syncState) throws Exception {
    return this.buildSyncFolderItemsRequest(syncFolderId, propertySet, ignoredItemIds, maxChangesReturned, syncScope, syncState).beginExecute(callback, null);
  }
  ...
  public ChangeCollection<FolderChange> syncFolderHierarchy(FolderId syncFolderId, PropertySet propertySet, String syncState) throws Exception {
    return this.buildSyncFolderHierarchyRequest(syncFolderId, propertySet, syncState).execute().getResponseAtIndex(0).getChanges();
  }
  ...
  public IAsyncResult beginSyncFolderHierarchy(AsyncCallback callback, Object state, FolderId syncFolderId, PropertySet propertySet, String syncState) throws Exception {
    return this.buildSyncFolderHierarchyRequest(syncFolderId, propertySet, syncState).beginExecute(callback, null);
  }
  ...
  public DelegateInformation getDelegates(Mailbox mailbox, boolean includePermissions, Iterable<UserId> userIds) throws Exception {
    ...
    DelegateInformation delegateInformation = new DelegateInformation((List<DelegateUserResponse>) response.getDelegateUserResponses(), response.getMeetingRequestsDeliveryScope());
   ...
   * @throws Exception the exception
   */
  protected UserConfiguration getUserConfiguration(String name, FolderId parentFolderId, UserConfigurationProperties properties) throws Exception {
    EwsUtilities.validateParam(name, "name");
    EwsUtilities.validateParam(parentFolderId, "parentFolderId");
   ...
   * @param redirectionEmailAddresses      the redirection email addresses
   * @param currentHop                     the current hop
  ...
  private URI getAutodiscoverUrl(String emailAddress, ExchangeVersion requestedServerVersion, IAutodiscoverRedirectionUrl validateRedirectionUrlCallback) throws Exception {
    ...
    switch (response.getErrorCode()) {
      ...
      default:
        this.traceMessage(TraceFlags.AutodiscoverConfiguration, String.format("No EWS Url returned for user %s, " + "error code is %s", emailAddress, response.getErrorCode()));
  ...
  private URI getEwsUrlFromResponse(GetUserSettingsResponse response, boolean isExternal) throws URISyntaxException, AutodiscoverLocalException {
    ...
    if ((response.tryGetSettingValue(String.class, UserSettingName.InternalEwsUrl, outParam) || response.tryGetSettingValue(String.class, UserSettingName.ExternalEwsUrl, outParam))) {
      uriString = outParam.getParam();
      if (!(uriString == null || uriString.isEmpty())) {
        return new URI(uriString);
      }
