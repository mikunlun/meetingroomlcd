...
public final class AutodiscoverError {
   ...
   */
  protected static AutodiscoverError parse(EwsXmlReader reader) throws Exception {
    ...
    do {
      ...
      if (reader.getNodeType().getNodeType() == XMLNodeType.START_ELEMENT) {
        ...
        } else if (reader.getLocalName().equalsIgnoreCase(XmlElementNames.Message)) {
          error.message = reader.readElementValue();
        } else if (reader.getLocalName().equalsIgnoreCase(XmlElementNames.DebugData)) {
