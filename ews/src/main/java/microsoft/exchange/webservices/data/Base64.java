...
class Base64 {
   ...
   * The char set.
   */
  static String strSet = "ABCDEFGHIJKLMNOPQRSTUVWXYZab" + "cdefghijklmnopqrstuvwxyz0123456789+/";
    ...
    for (int i = startIndex; i < max; i++) {
      ...
      switch (++curState) {
        case 1:
          ...
          break;
        case 2:
          resArry[resIndex++] = dataArry[((prev << 4) & 0x30) | ((x >> 4) & 0xf)];
          break;
        case 3:
          resArry[resIndex++] = dataArry[((prev << 2) & 0x3C) | ((x >> 6) & 0x3)];
