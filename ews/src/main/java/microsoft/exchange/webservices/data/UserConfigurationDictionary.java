...
public final class UserConfigurationDictionary extends ComplexProperty implements Iterable<Object> {
  ...
  private void writeObjectToXml(EwsServiceXmlWriter writer, String xmlElementName, Object dictionaryObject) throws XMLStreamException, ServiceXmlSerializationException {
    ...
    if (dictionaryObject == null) {
      EwsUtilities.EwsAssert((!xmlElementName.equals(XmlElementNames.DictionaryKey)), "UserConfigurationDictionary.WriteObjectToXml", "Key is null");
   ...
   *
   * @param writer           The writer.
   * @param dictionaryObject The dictionary object to write.
   * @throws XMLStreamException the xML stream exception
   * @throws ServiceXmlSerializationException
   *                            the service xml serialization exception
   */
  ...
  private List<String> getObjectValue(EwsServiceXmlReader reader, UserConfigurationDictionaryObjectType type) throws Exception {
    ...
    do {
      ...
      if (reader.isEmptyElement()) {
        ...
        if (type.equals(UserConfigurationDictionaryObjectType.String) || type.equals(UserConfigurationDictionaryObjectType.
                StringArray)) {
          value = "";
        } else {
  ...
  private Object constructObject(UserConfigurationDictionaryObjectType type, List<String> value, EwsServiceXmlReader reader) {
    ...
    } else if (type.equals(UserConfigurationDictionaryObjectType.
            UnsignedInteger32)) {
      dictionaryObject = Integer.parseInt(value.get(0));
    } else if (type.equals(UserConfigurationDictionaryObjectType.
            UnsignedInteger64)) {
  ...
  private void validateArrayObject(Object[] dictionaryObjectAsArray) throws ServiceLocalException {
    ...
    if (dictionaryObjectAsArray instanceof String[]) {
      ...
      throw new ServiceLocalException(String.format(Strings.ObjectTypeNotSupported, dictionaryObjectAsArray.getClass()));
    }
  }
