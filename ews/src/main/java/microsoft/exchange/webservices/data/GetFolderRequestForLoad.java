 ...
 */
final class GetFolderRequestForLoad extends GetFolderRequestBase<ServiceResponse> {
   ...
   * @throws Exception
   */
  protected GetFolderRequestForLoad(ExchangeService exchangeService, ServiceErrorHandling throwonerror) throws Exception {
  ...
  protected ServiceResponse createServiceResponse(ExchangeService service, int responseIndex) {
    return new GetFolderResponse(this.getFolderIds().getFolderIdWrapperList(responseIndex).getFolder(), this.getPropertySet());
  }
