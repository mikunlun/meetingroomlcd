...
public class FolderSchema extends ServiceObjectSchema {
  ...
  private static class FieldUris {
     ...
     */
    public final static String ManagedFolderInformation = "folder:ManagedFolderInformation";
   ...
   */
  public static final PropertyDefinition Id = new ComplexPropertyDefinition<FolderId>(FolderId.class, XmlElementNames.FolderId, FieldUris.FolderId, EnumSet.of(PropertyDefinitionFlags.CanFind), ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<FolderId>() {
   ...
   */
  public static final PropertyDefinition ParentFolderId = new ComplexPropertyDefinition<FolderId>(FolderId.class, XmlElementNames.ParentFolderId, FieldUris.ParentFolderId, EnumSet.of(PropertyDefinitionFlags.CanFind), ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<FolderId>() {
    public FolderId createComplexProperty() {
      return new FolderId();
    }
  });
   ...
   */
  public static final PropertyDefinition ManagedFolderInformation = new ComplexPropertyDefinition<ManagedFolderInformation>(ManagedFolderInformation.class, XmlElementNames.ManagedFolderInformation, FieldUris.ManagedFolderInformation, EnumSet.of(PropertyDefinitionFlags.CanFind), ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<ManagedFolderInformation>() {
