...
class EwsServiceMultiResponseXmlReader extends EwsServiceXmlReader {
   ...
   * @throws Exception
   */
  protected static EwsServiceMultiResponseXmlReader create(InputStream stream, ExchangeService service) throws Exception {
   ...
   */
  private static XMLEventReader createXmlReader(InputStream stream) throws XMLStreamException {
