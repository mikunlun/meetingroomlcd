...
public abstract class WSSecurityBasedCredentials extends ExchangeCredentials {
  ...
  protected static final String wsuTimeStampFormat = "<wsu:Timestamp>" +
...
//kavi-start
   ...
   */
  protected static final String wsAddressingHeadersFormat = "<wsa:Action soap:mustUnderstand='1'>http://schemas.microsoft.com/exchange/services/2006/messages/%s</wsa:Action>" +
   ...
   */
  protected static final String wsSecurityHeaderFormat = "<wsse:Security soap:mustUnderstand='1'>" +
  ...
  protected void emitExtraSoapHeaderNamespaceAliases(XMLStreamWriter writer) throws XMLStreamException {
    writer.writeAttribute("xmlns", EwsUtilities.WSSecuritySecExtNamespacePrefix, null, EwsUtilities.WSSecuritySecExtNamespace);
    writer.writeAttribute("xmlns", EwsUtilities.WSAddressingNamespacePrefix, null, EwsUtilities.WSAddressingNamespace);
  }
  ...
  private void serializeWSAddressingHeaders(XMLStreamWriter xmlWriter, String webMethodName) throws XMLStreamException {
    ...
    String wsAddressingHeaders = String.format(WSSecurityBasedCredentials.wsAddressingHeadersFormat, webMethodName, this.ewsUrl);
  ...
  protected void serializeWSSecurityHeaders(XMLStreamWriter xmlWriter) throws XMLStreamException {
    ...
    String wsSecurityHeader = String.format(WSSecurityBasedCredentials.wsSecurityHeaderFormat, timestamp + this.securityToken);
