...
public class Contact extends Item {
  ...
  protected void validate() throws ServiceVersionException, Exception {
    ...
    if (this.tryGetProperty(ContactSchema.FileAsMapping, outParam)) {
      ...
      EwsUtilities.validateEnumVersionValue((FileAsMapping) fileAsMapping, this.getService().getRequestedServerVersion());
    }
  }
  ...
  public FileAsMapping getFileAsMapping() throws ServiceLocalException {
    return (FileAsMapping) this.getPropertyBag().getObjectFromPropertyDefinition(ContactSchema.FileAsMapping);
  }
  ...
  public ImAddressDictionary getImAddresses() throws ServiceLocalException {
    return (ImAddressDictionary) getPropertyBag().getObjectFromPropertyDefinition(ContactSchema.ImAddresses);
  }
