...
public enum UserConfigurationProperties {
   ...
   */
  UserConfigurationProperties(UserConfigurationProperties id, UserConfigurationProperties dictionary, UserConfigurationProperties xmlData, UserConfigurationProperties binaryData) {
