...
final class SuppressReadReceipt extends ServiceObject {
  ...
  protected SuppressReadReceipt(Item referenceItem) throws Exception {
    ...
    EwsUtilities.EwsAssert(referenceItem != null, "SuppressReadReceipt.ctor", "referenceItem is null");
   ...
   * @throws Exception the exception
   */
  protected void internalCreate(FolderId parentFolderId, MessageDisposition messageDisposition) throws Exception {
