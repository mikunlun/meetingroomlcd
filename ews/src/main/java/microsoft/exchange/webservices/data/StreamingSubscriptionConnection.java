...
public final class StreamingSubscriptionConnection implements Closeable, HangingServiceRequestBase.IHandleResponseObject, HangingServiceRequestBase.IHangingRequestDisconnectHandler {
   ...
   * @throws Exception
   * @throws Thrown    when AddSubscription is called while connected.
   */
   ...
   * @throws Exception
   * @throws Thrown    when RemoveSubscription is called while connected.
   */
   ...
   * @throws Thrown                when Open is called while connected.
   */
   ...
   *
   * @throws Thrown when Close is called while not connected.
   */
  public void close() {
    synchronized (this) {
      try {
