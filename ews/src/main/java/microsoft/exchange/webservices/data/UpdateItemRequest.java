 ...
 */
final class UpdateItemRequest extends MultiResponseServiceRequest<UpdateItemResponse> {
  ...
  protected void validate() throws ServiceLocalException, Exception {
    ...
    for (int i = 0; i < this.getItems().size(); i++) {
      if ((this.getItems().get(i) == null) || this.getItems().get(i).isNew()) {
  ...
  protected void writeAttributesToXml(EwsServiceXmlWriter writer) throws ServiceXmlSerializationException {
    ...
    if (this.sendInvitationsOrCancellationsMode != null) {
      writer.writeAttributeValue(XmlAttributeNames.SendMeetingInvitationsOrCancellations, this.sendInvitationsOrCancellationsMode);
    }
  }
