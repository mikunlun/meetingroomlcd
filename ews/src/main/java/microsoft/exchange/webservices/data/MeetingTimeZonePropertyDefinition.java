...
class MeetingTimeZonePropertyDefinition extends PropertyDefinition {
   ...
   */
  protected MeetingTimeZonePropertyDefinition(String xmlElementName, String uri, EnumSet<PropertyDefinitionFlags> flags, ExchangeVersion version) {
  ...
  protected final void loadPropertyValueFromXml(EwsServiceXmlReader reader, PropertyBag propertyBag) throws Exception {
    ...
    propertyBag.setObjectFromPropertyDefinition(AppointmentSchema.StartTimeZone, meetingTimeZone.toTimeZoneInfo());
  }
