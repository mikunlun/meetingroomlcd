...
public class MeetingMessageSchema extends EmailMessageSchema {
   ...
   */
  public static final PropertyDefinition AssociatedAppointmentId = new ComplexPropertyDefinition<ItemId>(
          //	ItemId.class,
          XmlElementNames.AssociatedCalendarItemId, FieldUris.AssociatedCalendarItemId, ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<ItemId>() {
    @Override
   ...
   */
  public static final PropertyDefinition IsDelegated = new BoolPropertyDefinition(XmlElementNames.IsDelegated, FieldUris.IsDelegated, EnumSet.of(PropertyDefinitionFlags.CanFind), ExchangeVersion.Exchange2007_SP1);

  /**
   * Defines the IsOutOfDate property.
   */
  public static final PropertyDefinition IsOutOfDate = new BoolPropertyDefinition(XmlElementNames.IsOutOfDate, FieldUris.IsOutOfDate, ExchangeVersion.Exchange2007_SP1);

  /**
   * Defines the HasBeenProcessed property.
   */
  public static final PropertyDefinition HasBeenProcessed = new BoolPropertyDefinition(XmlElementNames.HasBeenProcessed, FieldUris.HasBeenProcessed, EnumSet.of(PropertyDefinitionFlags.CanFind), ExchangeVersion.Exchange2007_SP1);

  /**
   * Defines the ResponseType property.
   */
  public static final PropertyDefinition ResponseType = new GenericPropertyDefinition<MeetingResponseType>(MeetingResponseType.class, XmlElementNames.ResponseType, FieldUris.ResponseType, EnumSet.of(PropertyDefinitionFlags.CanFind), ExchangeVersion.Exchange2007_SP1);
