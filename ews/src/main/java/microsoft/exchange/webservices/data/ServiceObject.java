...
public abstract class ServiceObject {
  ...
  protected String getXmlElementName() {
    ...
    EwsUtilities.EwsAssert(!isNullOrEmpty(this.xmlElementName), "EwsObject.GetXmlElementName", String.format("The class %s does not have an " + "associated XML element name.", this.getClass().getName()));
  ...
  protected void loadFromXml(EwsServiceXmlReader reader, boolean clearPropertyBag) throws Exception {
    ...
    this.getPropertyBag().loadFromXml(reader, clearPropertyBag, null, // propertySet
