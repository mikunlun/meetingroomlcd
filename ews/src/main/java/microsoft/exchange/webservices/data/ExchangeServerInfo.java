...
public final class ExchangeServerInfo {
   ...
   */
  protected static ExchangeServerInfo parse(EwsServiceXmlReader reader) throws Exception {
    EwsUtilities.EwsAssert(reader.hasAttributes(), "ExchangeServerVersion.Parse", "Current element doesn't have attributes");
