...
abstract class CreateItemResponseBase extends ServiceResponse implements IGetObjectInstanceDelegate<ServiceObject> {
   ...
   */
  protected abstract Item getObjectInstance(ExchangeService service, String xmlElementName) throws InstantiationException, IllegalAccessException, Exception;
  ...
  protected void readElementsFromXml(EwsServiceXmlReader reader) throws Exception {
    ...
    this.items = reader.readServiceObjectsCollectionFromXml(XmlElementNames.Items, this, false, /* clearPropertyBag */
