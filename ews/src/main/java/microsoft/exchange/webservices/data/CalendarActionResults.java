...
public final class CalendarActionResults {
  ...
  CalendarActionResults(Iterable<Item> items) {
    ...
    this.meetingRequest = EwsUtilities.findFirstItemOfType(MeetingRequest.class, items);
    this.meetingResponse = EwsUtilities.findFirstItemOfType(MeetingResponse.class, items);
    this.meetingCancellation = EwsUtilities.findFirstItemOfType(MeetingCancellation.class, items);
  }
