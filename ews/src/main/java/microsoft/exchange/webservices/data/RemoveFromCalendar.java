...
class RemoveFromCalendar extends ServiceObject {
  ...
  RemoveFromCalendar(Item referenceItem) throws Exception {
    ...
    EwsUtilities.EwsAssert(referenceItem != null, "RemoveFromCalendar.ctor", "referenceItem is null");
   ...
   * @throws Exception the exception
   */
  protected List<Item> internalCreate(FolderId parentFolderId, MessageDisposition messageDisposition) throws Exception {
