 ...
 */
abstract class MoveCopyRequest<TServiceObject extends ServiceObject, TResponse extends ServiceResponse> extends MultiResponseServiceRequest<TResponse> {
   ...
   * @throws Exception the exception
   */
  protected abstract void writeIdsToXml(EwsServiceXmlWriter writer) throws Exception;
