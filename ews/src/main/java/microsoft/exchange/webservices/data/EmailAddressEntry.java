...
public final class EmailAddressEntry extends DictionaryEntryProperty<EmailAddressKey> implements IComplexPropertyChangedDelegate {
  ...
  protected void readAttributesFromXml(EwsServiceXmlReader reader) throws Exception {
    ...
    this.getEmailAddress().setName(reader.readAttributeValue((String) XmlAttributeNames.Name));
    this.getEmailAddress().setRoutingType(reader.readAttributeValue((String) XmlAttributeNames.
            RoutingType));
