...
class EwsXmlReader {
  ...
  public String readValue() throws XMLStreamException, ServiceXmlDeserializationException {
    ...
    if (this.presentEvent.isStartElement()) {
      ...
      if (this.presentEvent.isCharacters()) {
        ...
        errMsg = errMsg + "Could not find " + XMLNodeType.getString(XMLNodeType.CHARACTERS);
      ...
      errMsg = errMsg + "Expected is " + XMLNodeType.getString(XMLNodeType.START_ELEMENT);
      throw new ServiceXmlDeserializationException(errMsg);
    }
  ...
  public void ensureCurrentNodeIsEndElement(XmlNamespace xmlNamespace, String localName) throws Exception {
    if (!this.isEndElement(xmlNamespace, localName)) {
      if (!(this.isStartElement(xmlNamespace, localName) && this.isEmptyElement())) {
        throw new ServiceXmlDeserializationException(String.format(Strings.ElementNotFound, xmlNamespace, localName));
      }
    }
  }
  ...
  public static boolean checkEndElement(XMLEvent startEvent, XMLEvent endEvent) {
    ...
    if (endEvent.isEndElement()) {
      ...
      isEndElement = qEName.getLocalPart().equals(qSName.getLocalPart()) && (qEName.getPrefix().equals(qSName.getPrefix()) || qEName.getNamespaceURI().equals(qSName.
              getNamespaceURI()));
