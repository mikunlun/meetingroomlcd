...
public final class OrderByCollection implements Iterable<Map<PropertyDefinitionBase, SortDirection>> {
   ...
   */
  private List<Map<PropertyDefinitionBase, SortDirection>> propDefSortOrderPairList;

  /**
   * Initializes a new instance of the OrderByCollection class.
   */
  protected OrderByCollection() {
    this.propDefSortOrderPairList = new ArrayList<Map<PropertyDefinitionBase, SortDirection>>();
  }
  ...
  public void add(PropertyDefinitionBase propertyDefinition, SortDirection sortDirection) throws ServiceLocalException {
    ...
    Map propertyDefinitionSortDirectionPair = new HashMap<PropertyDefinitionBase, SortDirection>();
  ...
  public boolean remove(PropertyDefinitionBase propertyDefinition) {
    List<Map<PropertyDefinitionBase, SortDirection>> removeList = new ArrayList<Map<PropertyDefinitionBase, SortDirection>>();
    for (Map propDefSortOrderPair : propDefSortOrderPairList) {
   ...
   */
  public boolean tryGetValue(PropertyDefinitionBase propertyDefinition, OutParam sortDirection) {
  ...
  protected void writeToXml(EwsServiceXmlWriter writer, String xmlElementName) throws XMLStreamException, ServiceXmlSerializationException {
    if (this.count() > 0) {
      ...
      for (Map<PropertyDefinitionBase, SortDirection> keyValuePair : this.propDefSortOrderPairList) {
        ...
        writer.writeAttributeValue(XmlAttributeNames.Order, keyValuePair.values().iterator().next());
