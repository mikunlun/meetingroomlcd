...
class EwsServiceXmlWriter implements IDisposable {
   ...
   */
  protected EwsServiceXmlWriter(ExchangeServiceBase service, OutputStream stream) throws XMLStreamException {
  ...
  public void writeAttributeValue(String localName, boolean alwaysWriteEmptyString, Object value) throws ServiceXmlSerializationException {
    ...
    if (this.tryConvertObjectToString(value, stringOut)) {
      ...
      throw new ServiceXmlSerializationException(String.format(Strings.AttributeValueCannotBeSerialized, value.getClass().getName(), localName));
    }
  }
  ...
  protected void writeAttributeString(String localName, String stringValue) throws ServiceXmlSerializationException {
    try {
      ...
      throw new ServiceXmlSerializationException(String.format(Strings.InvalidAttributeValue, stringValue, localName), e);
    }
  }
  ...
  public void writeValue(String value, String name) throws ServiceXmlSerializationException {
    try {
      ...
      // Bug E14:65046: XmlTextWriter will throw ArgumentException
      //if string includes invalid characters.
      throw new ServiceXmlSerializationException(String.format(Strings.InvalidElementStringValue, value, name), e);
    }
  }
   ...
   *                            the service xml serialization exception
   */
  protected void writeElementValue(XmlNamespace xmlNamespace, String localName, String displayName, Object value) throws XMLStreamException, ServiceXmlSerializationException {
    String stringValue = null;
    ...
    if (this.tryConvertObjectToString(value, strOut)) {
      ...
      throw new ServiceXmlSerializationException(String.format(Strings.ElementValueCannotBeSerialized, value.getClass().getName(), localName));
    }
  }
  ...
  public static void writeNode(Node xmlNode, XMLStreamWriter xmlStreamWriter) throws XMLStreamException {
    if (xmlNode instanceof Element) {
      ...
      xmlStreamWriter.writeEntityRef(((EntityReference) xmlNode).getNodeValue());
